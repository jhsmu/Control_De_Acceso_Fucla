                ...
                <form action="./ingreso/ingresoinvitado.php" method="post">
                    <div class="row pt-2">
                        <div class="col-6">
                            ...
                            <input type="text" name="nombre" id="nombre" placeholder="Digite sus nombres" onchange="nombre1()">
                        </div>
                        <div class="col-6 pt-2">
                            <label for="apellido">Apellido</label>
                            <input type="text" name="apellido" id="apellido" placeholder="Digite sus apellidos" onchange="apellido1()">
                        </div>
                    </div>
                    <div class="row pt-2">
                        <div class="col-6">
                            <label for="cudula">Documento</label>
                            <input type="text" name="documento" id="documento" placeholder="Digite su numero de documento" onchange="cedula1()">
                        </div>
                        <div class="col-6 pt-2">
                            <label for="telefono">Telefono</label>
                            <input type="text" name="telefono" id="telefono" placeholder="Digite sus numero de telefono" onchange="telefono1()">
                        </div>
                    </div>
